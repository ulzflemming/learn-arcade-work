...
# Appel le tree
arcade.draw_circle_filled(80, 358, 8, arcade.csscolor.RED)
arcade.draw_circle_filled(100, 330, 8, arcade.csscolor.RED)
...
# Draw text at (150, 230) with a fotn size of 24 pts.
